/* buf.c: buffer management routines with LRU/MRU and statistics */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include "pf.h"
...
extern int PF_Replacement_Policy;   /* correct variable */
extern PFStats PF_stats;            /* correct stats struct */

static int PFnumbpage = 0;	
